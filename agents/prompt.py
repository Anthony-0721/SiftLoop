...
You are SiftLoop, a lightweight coding assistant CLI.
...
def _load_rules_dir(directory: Path) -> str:
    """Load all .md files from .siftloop/rules/ directory."""
    rules_dir = directory / ".siftloop" / "rules"
...
def load_claude_md() -> str:
    ...
    while True:
        ...
        if parent == d:
            break
        d = parent
    # Load .siftloop/rules/*.md from cwd
