...
def print_welcome() -> None:
    title = Text("SiftLoop", style="bold #f6c177")
    subtitle = Text("Self-Evolving Coding Agent CLI", style="bold cyan")
    cookie = Text(COOKIE_SIFTLOOP, style="bold #d19a66")
    ...
    console.print(Panel(
        body,
        title="[bold #f6c177] sift loop ready [/bold #f6c177]",
...
def print_user_prompt() -> None:
    console.print("\n[bold #f6c177]SiftLoop[/bold #f6c177] [dim]❯[/dim] ", end="")
...
def print_goodbye() -> None:
    console.print(Panel(
        Text("Session saved. See you next loop.", style="bold #f6c177"),
        border_style="#d19a66",
        box=box.ROUNDED,
        padding=(0, 1),
    ))
